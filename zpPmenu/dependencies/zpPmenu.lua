...
function ZPMenu:stringsplit(inputstr, sep)
...
function ZPMenu:CloseMenu(bypass)
...
function ZPMenu:GetButtons(customMenu)
...
function ZPMenu:OpenMenu(stringName, boolBack)

	if stringName and not self.Menu[stringName] then print("[ZPMenu] " .. stringName .. " (erreur)") return end
...
function ZPMenu:CreateMenu(tableMenu, tempData)
...
function ZPMenu:ProcessControl()
...
function ZPMenu:drawMenuButton(button, intX, intY, boolSelected, intW, intH, intID)
...
function ZPMenu:DrawButtons(tableButtons)
...
function ZPMenu:DrawHeader(intCount)
...
function ZPMenu:DrawHelpers(tableButtons)
...
function ZPMenu:DrawExtra(tableButtons)
	ShowCursorThisFrame()
...
function CloseMenu(force)
	return ZPMenu:CloseMenu(force)
end

function CreateMenu(arrayMenu, tempData)
	return ZPMenu:CreateMenu(arrayMenu, tempData)
end

function OpenMenu(stringName)
	return ZPMenu:OpenMenu(stringName)
end
...
Citizen.CreateThread(function()
	while true do
		...
		if ZPMenu.IsVisible and not ZPMenu.Invisible then
			ZPMenu:ProcessControl()
		end
	end
end)
